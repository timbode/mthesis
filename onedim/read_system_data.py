...
constants=[]
with open('data/system.txt') as f:
	for line in f:
		if line.startswith('#'):
...
From=0
To=steps
TimePlots(steps, steps/5, From, To)
TimePlots(steps, steps/5, From, To, what='velocities')
#TimePlots(steps, steps/5, From, To, what='lattice_velocities')
